...
<html>
  <head>
    <?php require_once("element/_5_config_header_meta_css_script.php"); ?>
    <title>SBG</title>
  ...
  <body>
    ...
    <div class="wrapper" id="page-top">
      <nav id="sidebar">
        ...
        <center>
          <a href="<?=_MAIN_DF;?>"><h4><img src="../plugin/images/logo_main2.png" width="120"></h4></a><br>
          <a href="<?=_MAIN_DF;?>"><h4><b>SMS Broadcast Gateway</b></h4></a>
        <center>
          <a href="<?=_MAIN_DF;?>"><strong>SBG</strong></a>
        </div>
        <ul class="list-unstyled components">
          ...
          <li class="nav-item">
            ...
            <center><i class="fa fa-fw fa-globe-asia"></i>
                Customer Account</center>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:gotoPage('sub_user&reset_search=1',-1);" <?php menuPermission($dest_file,"sub_user");?>>
            <center><i class="fa fa-fw fa-globe-asia"></i>
                Sub-user Manage</center>
            </a>
          </li>
          <?php
            }
          ...
          ?>
          <li class="nav-item">
            <a class="nav-link" href="javascript:gotoPage('sender_list&reset_search=1',-1);" <?php menuPermission($dest_file,"sender_list");?>>
              <center><i class="fa fa-fw fa-file-alt"></i>
                Sender List</center>
            </a>
          </li>
          ...
          ?>
          <li class="nav-item">
            <a class="nav-link" href="javascript:gotoPage('sum_report&reset_search=1',-1);" <?php menuPermission($dest_file,"sum_report");?>>
              <center><i class="fa fa-fw fa-file-alt"></i>
                Summary Report</center>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:gotoPage('sender&reset_search=1',-1);" <?php menuPermission($dest_file,"sender");?>>
              <center><i class="fa fa-share"></i>
                Sender</center>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:gotoPage('blacklist&reset_search=1',-1);" <?php menuPermission($dest_file,"blacklist");?>>
              <center><i class="fa fa-lock"></i>
                Blacklist</center>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:gotoPage('department&reset_search=1',-1);" <?php menuPermission($dest_file,"department");?>>
              <center><i class="fa fa-key"></i>
                Departments</center>
            </a>
          </li>
          <?php
          ...
          ?>
          <li class="nav-item">
            <a class="nav-link" href="javascript:gotoPage('keyword&reset_search=1',-1);" <?php menuPermission($dest_file,"keyword");?>>
              <center><i class="fa fa-key"></i>
                Keywords</center>
            </a>
          </li>
          ...
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="nav-item dropdown">
                ...
                <button formaction="#" type="button" data-toggle="dropdown" id="userDropdown" class="btn btn-dark">  
                <i class='fas fa-user-alt'></i>  <?=$_SESSION[_SES_USR_NAME];?> [<?=$_SESSION[_SES_USR_TYP_NAME];?>] &nbsp;<i class='fas fa-angle-double-down'></i>
                </button>
                <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--grow-in" aria-labelledby="userDropdown"><!-- Dropdown - User Information -->
                  ...
                  <a href="javascript:gotoPageWithLastParam('<?php echo $dest_file;?>', -1, 10);" class="dropdown-item">
                    10 <?php if($max_rows==10) echo "<i class=\"fa fa-sm fa-fw fa-check-circle mr-2 text-gray-400\"></i>" ?>
                  </a>
                  <a href="javascript:gotoPageWithLastParam('<?php echo $dest_file;?>', -1, 50);" class="dropdown-item">
                    50 <?php if($max_rows==50) echo "<i class=\"fa fa-sm fa-fw fa-check-circle mr-2 text-gray-400\"></i>" ?>
                  </a>
                  <a href="javascript:gotoPageWithLastParam('<?php echo $dest_file;?>', -1, 100);" class="dropdown-item">
                    100 <?php if($max_rows==100) echo "<i class=\"fa fa-sm fa-fw fa-check-circle mr-2 text-gray-400\"></i>" ?>
                  </a>
                  <a href="javascript:gotoPageWithLastParam('<?php echo $dest_file;?>', -1, 200);" class="dropdown-item">
